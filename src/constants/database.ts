...
const QUERIES = {
  USER: {
    ...
    INSERT_USER: `INSERT INTO ${TABLES.CLIENT_MASTER} (${COLUMNS.USER.EMAIL}, ${COLUMNS.USER.NAME}, ${COLUMNS.USER.PASSWORD}, ${COLUMNS.USER.TOOL}, ${COLUMNS.USER.ORGANIZATION}) VALUES ($1, $2, $3, $4, $5) RETURNING *`,
  },
};
